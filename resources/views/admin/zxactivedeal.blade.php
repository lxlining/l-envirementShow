...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" method="post" action="{{url('/admin/zxactivedeal')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="file" id="L_truename" name="img" required="" lay-verify="truename" autocomplete="off" class="layui-input "></div>
            </div>
