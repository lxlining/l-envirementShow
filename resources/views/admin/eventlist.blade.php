                        ...
                        @foreach($data as $val)
                            <tr>
                                ...
                                <td class="td-manage">&emsp;
                                    <a title="处理" onclick="xadmin.open('处理','{{url('/admin/eventdeal/'.$val->id)}}')" >
                                        <i class="layui-icon">&#xe63c;</i></a>&emsp;&emsp;
                                    <a title="删除" onclick="xadmin.open('处理','{{url('/admin/eventdel/'.$val->id)}}')" >
                                        <i class="layui-icon">&#xe640;</i></a>
                                </td>
                                    @else<td class="td-manage">不可操作</td>
                                    @endif
                            </tr>
