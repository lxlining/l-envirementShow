...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" method="post" action="{{url('/admin/noticeedit/').$id}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_email" name="atitle" required="" lay-verify="email" autocomplete="off" class="layui-input">{{$data[0]->atitle}}</div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea type="text" name="acontent" cols="60" rows="4">{{$data[0]->acontent}}</textarea></div>
            </div>
            <div class="layui-form-item">
