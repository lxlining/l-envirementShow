...
<html>
	...
	<style type="text/css">
		...
		.detail table tr td .titled{font-size: 18px; font-weight: bold; color: #000; margin-top: 10px; word-wrap:break-word; word-break:break-all;}
		.detail table tr td .content{color: gray; font-size: 16px; background-color: rgb(247,248,252); width: 695px; padding: 10px;}
